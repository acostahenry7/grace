    ...
    socket.broadcast
      ...
      .emit(
        ...
        formatMessage(
          user.id,
          botName,
          gravatar.url(user.email, { d: "identicon" }),
    ...
    if (user) {
      io.to(user.room).emit(
        ...
        formatMessage(
          user.id,
          botName,
          gravatar.url("josevalentin02@gmail.com", { d: "identicon" }),
